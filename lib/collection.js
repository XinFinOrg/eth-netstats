...
Collection.prototype.getNode = function(id)
{
  var index = this.getIndex({ id });
  return (index >= 0 ? this.getNodeByIndex(index) : undefined);
}
...
let collection;
const initializeCollection = (external) => {
  collection = new Collection(external);
}
const getCollection = () =>  {
  return collection;
}

module.exports = {initializeCollection, getCollection};
